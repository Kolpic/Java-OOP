...
public class ControllerImpl implements Controller {
    ...
    public String addAnimal(String areaName, String animalType, String animalName, String kind, double price) {
        ...
        Area neededArea = areas.get(areaName);

        String areaType = neededArea.getClass().getSimpleName();
...
//        return String.format(ANIMALS_FED,neededArea.getAnimals().size());
        ...
        int counterAnimalsFed = 0;

        for (Animal currentAnimal : neededArea.getAnimals()) {
            currentAnimal.eat();
            counterAnimalsFed++;
        }
        return String.format(ANIMALS_FED, counterAnimalsFed);
    }
    ...
    public String calculateKg(String areaName) {
        ...
        double sumAllAnimalsKG = 0;
        for (Animal animal : neededArea.getAnimals()) {
            sumAllAnimalsKG += animal.getKg();
        }

        return String.format(KILOGRAMS_AREA,areaName,sumAllAnimalsKG);
    }
